...
<div class="register-box text-center">
    ...
    <form method="POST">
        ...
        <div class="mb-3 text-start">
            ...
            <input type="text" name="no_hp" class="form-control" placeholder="Contoh: 08123456789" maxlength="15" required>
        </div>
    ...
    <div class="mt-4">
        Sudah punya akun?
        <br>
        <a href="login.php" class="fw-bold text-decoration-underline">Masuk di sini</a>
    </div>
