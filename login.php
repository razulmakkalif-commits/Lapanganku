<?php
session_start(); // <-- WAJIB ditambahkan di baris paling atas sebelum kode lainnya
...
if(isset($_POST['login'])){
    ...
    /** @var mysqli $koneksi */ // <-- Menghilangkan garis merah di text editor
    $query = mysqli_query(
        $koneksi,
...
<head>
    ...
    <style>
        ...
        .subtitle{ color: #d9d9d9; margin-bottom: 30px; }
...
<div class="login-box text-center">
    ...
    <div class="subtitle">Sistem Booking Lapangan Futsal Modern</div>
